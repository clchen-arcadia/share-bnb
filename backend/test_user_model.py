...
class UserModelTestCase(TestCase):
    def setUp(self):
        ...
        u1 = User.signup("u1", "u1@email.com", "password", "first_name1", "last_name1")
        u2 = User.signup("u2", "u2@email.com", "password", "first_name2", "last_name2")
    ...
    def test_user_model(self):
        ...
        self.assertEqual(len(u1.messages_from), 0)
        self.assertEqual(len(u1.messages_to), 0)
    ...
    def test_user_repr(self):
        ...
        self.assertIn(
            test_repr,
            f"<User: {u1.username}, {u1.email}, {u1.first_name} {u1.last_name}>"
        )
    ...
    def test_user_signup(self):
        ...
        with self.assertRaises(exc.IntegrityError):
            User.signup("u3", None, "password", None, None)
            db.session.flush()
        ...
        with self.assertRaises(exc.IntegrityError):
            User.signup("u1", "email@email.com","password", "first", "last")
            db.session.flush()
    ...
    def test_user_authenticate(self):
        ...
        u1 = User.query.get(self.u1_username)
        print("u1 is", u1, type(u1))
        print("u1_auth is", u1_auth, type(u1_auth))
        self.assertEqual(u1, u1_auth[0]) #TODO: why is this a tuple anyways?
